                ...
                var getUpdate = function() {
                    ...
                    $.ajax({
                        ...
                        success: function(feed)
                        {
                            ...
                            if (comment_url){
                                var html = "<ul><li style='display:none' class='easyfb_user_input'><input class='comment' type='text' value='Ã‰crire un commentaire...' rel="+hash+" onblur='if(this.value == \"\") { this.value = \"Ã‰crire un commentaire...\"}' onclick='if(this.value == \"Ã‰crire un commentaire...\") { this.value = \"\"}'/><a href='#' class='publier'>Publier</a></li>";
                            ...
                            $(data).each(function(i, elt){
                                ...
                                if(elt.from){
                                    ...
                                    if (comment_url){
                                        ...
                                        var input = "<div style='display:none' class='easyfb_user_input'><input class='comment' type='text' value='Ã‰crire un commentaire...' rel="+elt.id+" onblur='if(this.value == \"\") { this.value = \"Ã‰crire un commentaire...\"}' onclick='if(this.value == \"Ã‰crire un commentaire...\") { this.value = \"\"}'/><a href='#' class='publier'>Publier</a></div>";
                                        if (elt.likes){
                            ...
                            $('.comment').bind('keypress', function(e) {
                                ...
                                if(e.keyCode==13){
                                    ...
                                    if (comment_url){
                                        ...
                                        var post = ' "'+params['message']+'" Ã  propos de '+ params['ids'];
                                        FB.api({
                                                method: 'status.set',
                                                status: post
                                            },
